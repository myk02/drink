...
const activations = [
  {
    ...
    description: "Sample GiGi at locations across Nairobi.",
    cta: "Find Events",
    href: "/events/tasting",
  },
  {
    icon: Dumbbell,
    title: "Gyms & Studios",
    description: "Partnered fitness centres fuelled by GiGi.",
    cta: "Partner With Us",
    href: "/events/gyms",
  },
  {
    ...
    description: "Power up your workplace. Bulk orders in Nairobi.",
    cta: "Get Quote",
  ...
  },
  {
    ...
    description: "Sponsor your next event with GiGi.",
    cta: "Sponsor Event",
...
export function ActivationsSection() {
  ...
  return (
    <section id="creators" className="relative py-16 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {activations.map((activation, index) => (
            <Link key={activation.title} href={activation.href}>
              <motion.div
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <motion.span
                    className="inline-flex items-center gap-2 text-[#AFFF00] group-hover:text-[#121212] font-bold text-xs tracking-wide transition-colors duration-300"
                    whileHover={{ x: 4 }}
                    transition={{ type: "spring", stiffness: 400, damping: 17 }}
                  >
                    {activation.cta}
