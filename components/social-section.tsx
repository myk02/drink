...
const instagramPosts = [
  { image: "/images/kenyan/1.jpg", likes: "3.1k" },
  { image: "/images/kenyan/2.jpg", likes: "2.7k" },
  { image: "/images/kenyan/3.jpg", likes: "4.2k" },
  { image: "/images/kenyan/4.jpg", likes: "1.8k" },
  { image: "/images/kenyan/5.jpg", likes: "2.3k" },
  { image: "/images/kenyan/6.jpg", likes: "3.5k" },
]
  ...
  return (
    <section id="creators" className="relative py-16 bg-[#121212] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <motion.a
            href="https://instagram.com/myk.ih_1"
            target="_blank"
          ...
          >
            ...
            <span className="relative z-10">Follow @myk.ih_1</span>
          </motion.a>
        </motion.div>
      </div>
    </section>
