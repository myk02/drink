...
const lifestyleImages = [
  ...
  { query: "kenyan athlete fitness workout gym energy sport", aspect: "landscape" },
  { query: "nairobi content creator streaming setup", aspect: "square" },
  { query: "kenyan student studying library nairobi", aspect: "landscape" },
  { query: "nairobi urban street style sunset", aspect: "portrait" },
  { query: "kenyan entrepreneur startup office nairobi meeting", aspect: "square" },
]

const socialPosts = [
  { handle: "@nyambura_music", text: "GiGi got me through my entire album recording at Homeboyz. 🔥", likes: "3.4k" },
  { handle: "@kipchoge_fit", text: "Zero sugar but 100% energy. My pre-workout go-to in Nairobi.", likes: "2.8k" },
  { handle: "@wambui_codes", text: "Finally an energy drink made in Kenya that doesn't taste like chemicals", likes: "1.2k" },
]
